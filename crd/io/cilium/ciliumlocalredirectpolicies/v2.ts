...
export class KubernetesCiliumLocalRedirectPolicyV2 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesCiliumLocalRedirectPolicyV2Config) {
    super(scope, id, {
      manifest: { apiVersion: "cilium.io/v2", kind: "CiliumLocalRedirectPolicy", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesCiliumLocalRedirectPolicyV2Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
