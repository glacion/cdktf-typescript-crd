...
export class KubernetesPolicyReportV1alpha2Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesPolicyReportV1alpha2ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesPolicyReportV1alpha2ManifestConfig extends ManifestConfig {
  manifest: {
