...
export class Wgpolicyk8sIoPolicyReportV1alpha2 extends Manifest {
  constructor(scope: Construct, id: string, config: Wgpolicyk8sIoPolicyReportV1alpha2Config) {
    super(scope, id, config);
  }
}
export interface Wgpolicyk8sIoPolicyReportV1alpha2Config extends ManifestConfig {
  manifest: {
