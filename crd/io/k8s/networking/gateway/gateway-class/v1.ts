...
export class GatewayNetworkingK8sIoGatewayClassV1 extends Manifest {
  constructor(scope: Construct, id: string, config: GatewayNetworkingK8sIoGatewayClassV1Config) {
    super(scope, id, config);
  }
}
export interface GatewayNetworkingK8sIoGatewayClassV1Config extends ManifestConfig {
  manifest: {
