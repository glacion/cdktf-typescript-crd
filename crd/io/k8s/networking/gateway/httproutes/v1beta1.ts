...
export class KubernetesHTTPRouteV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesHTTPRouteV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "gateway.networking.k8s.io/v1beta1", kind: "HTTPRoute", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesHTTPRouteV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
