...
export class GatewayNetworkingK8sIoHTTPRouteV1 extends Manifest {
  constructor(scope: Construct, id: string, config: GatewayNetworkingK8sIoHTTPRouteV1Config) {
    super(scope, id, config);
  }
}
export interface GatewayNetworkingK8sIoHTTPRouteV1Config extends ManifestConfig {
  manifest: {
