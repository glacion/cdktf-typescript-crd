...
export class KubernetesReferenceGrantV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesReferenceGrantV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "gateway.networking.k8s.io/v1beta1", kind: "ReferenceGrant", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesReferenceGrantV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
