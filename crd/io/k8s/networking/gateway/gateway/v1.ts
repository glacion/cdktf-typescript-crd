...
export class GatewayNetworkingK8sIoGatewayV1 extends Manifest {
  constructor(scope: Construct, id: string, config: GatewayNetworkingK8sIoGatewayV1Config) {
    super(scope, id, config);
  }
}
export interface GatewayNetworkingK8sIoGatewayV1Config extends ManifestConfig {
  manifest: {
