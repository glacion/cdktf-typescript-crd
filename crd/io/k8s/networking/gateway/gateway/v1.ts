...
export class KubernetesGatewayV1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesGatewayV1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesGatewayV1ManifestConfig extends ManifestConfig {
  manifest: {
