...
export class GatewayNetworkingK8sIoGatewayV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: GatewayNetworkingK8sIoGatewayV1beta1Config) {
    super(scope, id, config);
  }
}
export interface GatewayNetworkingK8sIoGatewayV1beta1Config extends ManifestConfig {
  manifest: {
