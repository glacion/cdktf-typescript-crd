...
export class ExternalSecretsIoExternalSecretV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ExternalSecretsIoExternalSecretV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ExternalSecretsIoExternalSecretV1beta1Config extends ManifestConfig {
  manifest: {
