...
export class KubernetesExternalSecretV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesExternalSecretV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "external-secrets.io/v1beta1", kind: "ExternalSecret", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesExternalSecretV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
