...
export class KubernetesClusterExternalSecretV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesClusterExternalSecretV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "external-secrets.io/v1beta1", kind: "ClusterExternalSecret", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesClusterExternalSecretV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
