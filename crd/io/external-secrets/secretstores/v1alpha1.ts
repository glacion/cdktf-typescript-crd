...
export class KubernetesSecretStoreV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesSecretStoreV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "external-secrets.io/v1alpha1", kind: "SecretStore", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesSecretStoreV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
