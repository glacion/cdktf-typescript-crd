...
export class KubernetesSecretStoreV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesSecretStoreV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "external-secrets.io/v1beta1", kind: "SecretStore", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesSecretStoreV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
