...
export class KubernetesACRAccessTokenV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesACRAccessTokenV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "generators.external-secrets.io/v1alpha1", kind: "ACRAccessToken", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesACRAccessTokenV1alpha1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
