...
export class KubernetesPushSecretV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesPushSecretV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "external-secrets.io/v1alpha1", kind: "PushSecret", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesPushSecretV1alpha1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
