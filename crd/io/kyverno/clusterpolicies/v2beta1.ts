...
export class KubernetesClusterPolicyV2beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesClusterPolicyV2beta1Config) {
    super(scope, id, { manifest: { apiVersion: "kyverno.io/v2beta1", kind: "ClusterPolicy", ...manifest }, ...config });
  }
}
export interface KubernetesClusterPolicyV2beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
