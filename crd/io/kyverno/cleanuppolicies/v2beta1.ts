...
export class KubernetesCleanupPolicyV2beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesCleanupPolicyV2beta1Config) {
    super(scope, id, { manifest: { apiVersion: "kyverno.io/v2beta1", kind: "CleanupPolicy", ...manifest }, ...config });
  }
}
export interface KubernetesCleanupPolicyV2beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
