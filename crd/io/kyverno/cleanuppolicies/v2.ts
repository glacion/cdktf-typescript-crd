...
export class KubernetesCleanupPolicyV2 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesCleanupPolicyV2Config) {
    super(scope, id, { manifest: { apiVersion: "kyverno.io/v2", kind: "CleanupPolicy", ...manifest }, ...config });
  }
}
export interface KubernetesCleanupPolicyV2Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
