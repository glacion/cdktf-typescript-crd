...
export class KubernetesPolicyV2beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesPolicyV2beta1Config) {
    super(scope, id, { manifest: { apiVersion: "kyverno.io/v2beta1", kind: "Policy", ...manifest }, ...config });
  }
}
export interface KubernetesPolicyV2beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
