...
export class KubernetesPolicyV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesPolicyV1Config) {
    super(scope, id, { manifest: { apiVersion: "kyverno.io/v1", kind: "Policy", ...manifest }, ...config });
  }
}
export interface KubernetesPolicyV1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
