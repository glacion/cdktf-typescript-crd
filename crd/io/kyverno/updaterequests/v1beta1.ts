...
export class KubernetesUpdateRequestV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesUpdateRequestV1beta1Config) {
    super(scope, id, { manifest: { apiVersion: "kyverno.io/v1beta1", kind: "UpdateRequest", ...manifest }, ...config });
  }
}
export interface KubernetesUpdateRequestV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
