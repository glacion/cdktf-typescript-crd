...
export class KubernetesUpdateRequestV2 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesUpdateRequestV2Config) {
    super(scope, id, { manifest: { apiVersion: "kyverno.io/v2", kind: "UpdateRequest", ...manifest }, ...config });
  }
}
export interface KubernetesUpdateRequestV2Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
