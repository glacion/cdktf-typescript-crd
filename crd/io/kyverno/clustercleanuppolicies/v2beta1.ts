...
export class KubernetesClusterCleanupPolicyV2beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesClusterCleanupPolicyV2beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "kyverno.io/v2beta1", kind: "ClusterCleanupPolicy", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesClusterCleanupPolicyV2beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
