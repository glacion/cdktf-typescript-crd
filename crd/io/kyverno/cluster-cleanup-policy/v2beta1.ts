...
export class KubernetesClusterCleanupPolicyV2beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesClusterCleanupPolicyV2beta1ManifestConfig) {
