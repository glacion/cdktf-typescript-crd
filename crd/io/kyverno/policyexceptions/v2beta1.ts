...
export class KubernetesPolicyExceptionV2beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesPolicyExceptionV2beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "kyverno.io/v2beta1", kind: "PolicyException", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesPolicyExceptionV2beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
