...
export class KubernetesPolicyExceptionV2 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesPolicyExceptionV2Config) {
    super(scope, id, { manifest: { apiVersion: "kyverno.io/v2", kind: "PolicyException", ...manifest }, ...config });
  }
}
export interface KubernetesPolicyExceptionV2Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
