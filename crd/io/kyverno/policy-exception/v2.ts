...
export class KyvernoIoPolicyExceptionV2 extends Manifest {
  constructor(scope: Construct, id: string, config: KyvernoIoPolicyExceptionV2Config) {
    super(scope, id, config);
  }
}
export interface KyvernoIoPolicyExceptionV2Config extends ManifestConfig {
  manifest: {
