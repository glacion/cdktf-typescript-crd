...
export class KubernetesPolicyExceptionV2Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesPolicyExceptionV2ManifestConfig) {
