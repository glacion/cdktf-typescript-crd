...
export class KubernetesGoogleCASClusterIssuerV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesGoogleCASClusterIssuerV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "cas-issuer.jetstack.io/v1beta1", kind: "GoogleCASClusterIssuer", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesGoogleCASClusterIssuerV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
