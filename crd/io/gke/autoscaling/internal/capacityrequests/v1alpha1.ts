...
export class KubernetesCapacityRequestV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesCapacityRequestV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "internal.autoscaling.gke.io/v1alpha1", kind: "CapacityRequest", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesCapacityRequestV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
