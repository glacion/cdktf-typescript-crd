...
export class KubernetesCapacityRequestV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesCapacityRequestV1Config) {
    super(scope, id, {
      manifest: { apiVersion: "internal.autoscaling.gke.io/v1", kind: "CapacityRequest", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesCapacityRequestV1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
