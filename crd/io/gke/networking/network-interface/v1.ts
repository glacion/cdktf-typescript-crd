...
export class NetworkingGkeIoNetworkInterfaceV1 extends Manifest {
  constructor(scope: Construct, id: string, config: NetworkingGkeIoNetworkInterfaceV1Config) {
    super(scope, id, config);
  }
}
export interface NetworkingGkeIoNetworkInterfaceV1Config extends ManifestConfig {
  manifest: {
