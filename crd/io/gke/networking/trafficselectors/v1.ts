...
export class KubernetesTrafficSelectorV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesTrafficSelectorV1Config) {
    super(scope, id, {
      manifest: { apiVersion: "networking.gke.io/v1", kind: "TrafficSelector", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesTrafficSelectorV1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
