...
export class NetworkingGkeIoGCPRoutingExtensionV1 extends Manifest {
  constructor(scope: Construct, id: string, config: NetworkingGkeIoGCPRoutingExtensionV1Config) {
    super(scope, id, config);
  }
}
export interface NetworkingGkeIoGCPRoutingExtensionV1Config extends ManifestConfig {
  manifest: {
