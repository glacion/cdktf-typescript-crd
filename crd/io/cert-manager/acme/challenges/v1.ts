...
export class KubernetesChallengeV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesChallengeV1Config) {
    super(scope, id, {
      manifest: { apiVersion: "acme.cert-manager.io/v1", kind: "Challenge", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesChallengeV1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
