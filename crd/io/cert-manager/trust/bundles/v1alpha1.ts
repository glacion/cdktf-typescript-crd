...
export class KubernetesBundleV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesBundleV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "trust.cert-manager.io/v1alpha1", kind: "Bundle", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesBundleV1alpha1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
