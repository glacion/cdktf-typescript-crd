...
export class KubernetesClusterIssuerV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesClusterIssuerV1Config) {
    super(scope, id, { manifest: { apiVersion: "cert-manager.io/v1", kind: "ClusterIssuer", ...manifest }, ...config });
  }
}
export interface KubernetesClusterIssuerV1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
