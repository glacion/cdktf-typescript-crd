...
export class KubernetesIssuerV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesIssuerV1Config) {
    super(scope, id, { manifest: { apiVersion: "cert-manager.io/v1", kind: "Issuer", ...manifest }, ...config });
  }
}
export interface KubernetesIssuerV1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
