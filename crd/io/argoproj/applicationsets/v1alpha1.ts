...
export class KubernetesApplicationSetV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesApplicationSetV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "argoproj.io/v1alpha1", kind: "ApplicationSet", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesApplicationSetV1alpha1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
