...
export class AutoscalingXK8sIoProvisioningRequestV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: AutoscalingXK8sIoProvisioningRequestV1beta1Config) {
    super(scope, id, config);
  }
}
export interface AutoscalingXK8sIoProvisioningRequestV1beta1Config extends ManifestConfig {
  manifest: {
