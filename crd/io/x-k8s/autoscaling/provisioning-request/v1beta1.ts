...
export class KubernetesProvisioningRequestV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesProvisioningRequestV1beta1ManifestConfig) {
