...
export class KueueXK8sIoWorkloadV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: KueueXK8sIoWorkloadV1beta1Config) {
    super(scope, id, config);
  }
}
export interface KueueXK8sIoWorkloadV1beta1Config extends ManifestConfig {
  manifest: {
