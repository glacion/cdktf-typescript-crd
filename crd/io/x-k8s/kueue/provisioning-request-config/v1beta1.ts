...
export class KubernetesProvisioningRequestConfigV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesProvisioningRequestConfigV1beta1ManifestConfig) {
