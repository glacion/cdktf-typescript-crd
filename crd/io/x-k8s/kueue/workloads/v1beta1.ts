...
export class KubernetesWorkloadV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesWorkloadV1beta1Config) {
    super(scope, id, { manifest: { apiVersion: "kueue.x-k8s.io/v1beta1", kind: "Workload", ...manifest }, ...config });
  }
}
export interface KubernetesWorkloadV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
