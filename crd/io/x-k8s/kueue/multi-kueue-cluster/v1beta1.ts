...
export class KueueXK8sIoMultiKueueClusterV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: KueueXK8sIoMultiKueueClusterV1beta1Config) {
    super(scope, id, config);
  }
}
export interface KueueXK8sIoMultiKueueClusterV1beta1Config extends ManifestConfig {
  manifest: {
