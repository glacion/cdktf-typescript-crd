...
export class KubernetesResourceFlavorV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesResourceFlavorV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "kueue.x-k8s.io/v1beta1", kind: "ResourceFlavor", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesResourceFlavorV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
