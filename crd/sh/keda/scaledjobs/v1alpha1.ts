...
export class KubernetesScaledJobV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesScaledJobV1alpha1Config) {
    super(scope, id, { manifest: { apiVersion: "keda.sh/v1alpha1", kind: "ScaledJob", ...manifest }, ...config });
  }
}
export interface KubernetesScaledJobV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
