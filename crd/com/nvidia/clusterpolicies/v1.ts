...
export class KubernetesClusterPolicyV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesClusterPolicyV1Config) {
    super(scope, id, { manifest: { apiVersion: "nvidia.com/v1", kind: "ClusterPolicy", ...manifest }, ...config });
  }
}
export interface KubernetesClusterPolicyV1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
