...
export class KubernetesAtlasDeploymentV1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesAtlasDeploymentV1ManifestConfig) {
