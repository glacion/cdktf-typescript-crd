...
export class KubernetesAtlasBackupCompliancePolicyV1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesAtlasBackupCompliancePolicyV1ManifestConfig) {
