...
export class AtlasMongodbComAtlasTeamV1 extends Manifest {
  constructor(scope: Construct, id: string, config: AtlasMongodbComAtlasTeamV1Config) {
    super(scope, id, config);
  }
}
export interface AtlasMongodbComAtlasTeamV1Config extends ManifestConfig {
  manifest: {
