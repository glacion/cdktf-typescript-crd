...
export class KubernetesPrometheusAgentV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesPrometheusAgentV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "monitoring.coreos.com/v1alpha1", kind: "PrometheusAgent", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesPrometheusAgentV1alpha1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
