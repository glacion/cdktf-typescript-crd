...
export class MonitoringCoreosComProbeV1 extends Manifest {
  constructor(scope: Construct, id: string, config: MonitoringCoreosComProbeV1Config) {
    super(scope, id, config);
  }
}
export interface MonitoringCoreosComProbeV1Config extends ManifestConfig {
  manifest: {
