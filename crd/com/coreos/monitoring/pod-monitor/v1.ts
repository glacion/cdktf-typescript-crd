...
export class MonitoringCoreosComPodMonitorV1 extends Manifest {
  constructor(scope: Construct, id: string, config: MonitoringCoreosComPodMonitorV1Config) {
    super(scope, id, config);
  }
}
export interface MonitoringCoreosComPodMonitorV1Config extends ManifestConfig {
  manifest: {
