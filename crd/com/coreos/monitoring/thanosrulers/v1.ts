...
export class KubernetesThanosRulerV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesThanosRulerV1Config) {
    super(scope, id, {
      manifest: { apiVersion: "monitoring.coreos.com/v1", kind: "ThanosRuler", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesThanosRulerV1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
