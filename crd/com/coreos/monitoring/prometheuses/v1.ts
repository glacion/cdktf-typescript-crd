...
export class KubernetesPrometheusV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesPrometheusV1Config) {
    super(scope, id, {
      manifest: { apiVersion: "monitoring.coreos.com/v1", kind: "Prometheus", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesPrometheusV1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
