...
export class KubernetesAlertmanagerV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesAlertmanagerV1Config) {
    super(scope, id, {
      manifest: { apiVersion: "monitoring.coreos.com/v1", kind: "Alertmanager", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesAlertmanagerV1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
