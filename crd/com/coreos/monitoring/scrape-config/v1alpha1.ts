...
export class MonitoringCoreosComScrapeConfigV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, config: MonitoringCoreosComScrapeConfigV1alpha1Config) {
    super(scope, id, config);
  }
}
export interface MonitoringCoreosComScrapeConfigV1alpha1Config extends ManifestConfig {
  manifest: {
