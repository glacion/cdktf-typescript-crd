...
export class MonitoringCoreosComServiceMonitorV1 extends Manifest {
  constructor(scope: Construct, id: string, config: MonitoringCoreosComServiceMonitorV1Config) {
    super(scope, id, config);
  }
}
export interface MonitoringCoreosComServiceMonitorV1Config extends ManifestConfig {
  manifest: {
