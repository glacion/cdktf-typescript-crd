...
export class KubernetesTrustConfigV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesTrustConfigV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "security.cloud.google.com/v1alpha1", kind: "TrustConfig", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesTrustConfigV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
