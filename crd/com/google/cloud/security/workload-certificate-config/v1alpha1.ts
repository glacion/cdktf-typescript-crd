...
export class KubernetesWorkloadCertificateConfigV1alpha1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesWorkloadCertificateConfigV1alpha1ManifestConfig) {
