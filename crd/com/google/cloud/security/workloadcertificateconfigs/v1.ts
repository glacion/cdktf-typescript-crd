...
export class KubernetesWorkloadCertificateConfigV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesWorkloadCertificateConfigV1Config) {
    super(scope, id, {
      manifest: { apiVersion: "security.cloud.google.com/v1", kind: "WorkloadCertificateConfig", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesWorkloadCertificateConfigV1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
