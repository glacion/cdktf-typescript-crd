...
export class SecurityCloudGoogleComTrustConfigV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, config: SecurityCloudGoogleComTrustConfigV1alpha1Config) {
    super(scope, id, config);
  }
}
export interface SecurityCloudGoogleComTrustConfigV1alpha1Config extends ManifestConfig {
  manifest: {
