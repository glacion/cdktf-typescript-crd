...
export class KubernetesTagsTagKeyV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesTagsTagKeyV1beta1ManifestConfig) {
