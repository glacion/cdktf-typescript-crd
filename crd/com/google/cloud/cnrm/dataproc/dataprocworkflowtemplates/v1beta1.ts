...
export class KubernetesDataprocWorkflowTemplateV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesDataprocWorkflowTemplateV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "dataproc.cnrm.cloud.google.com/v1beta1", kind: "DataprocWorkflowTemplate", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesDataprocWorkflowTemplateV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
