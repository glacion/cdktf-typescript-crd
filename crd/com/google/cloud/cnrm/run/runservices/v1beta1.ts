...
export class KubernetesRunServiceV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesRunServiceV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "run.cnrm.cloud.google.com/v1beta1", kind: "RunService", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesRunServiceV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
