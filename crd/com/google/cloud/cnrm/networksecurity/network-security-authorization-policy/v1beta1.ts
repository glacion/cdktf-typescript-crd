...
export class KubernetesNetworkSecurityAuthorizationPolicyV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesNetworkSecurityAuthorizationPolicyV1beta1ManifestConfig) {
