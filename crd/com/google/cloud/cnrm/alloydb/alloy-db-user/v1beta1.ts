...
export class AlloydbCnrmCloudGoogleComAlloyDBUserV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: AlloydbCnrmCloudGoogleComAlloyDBUserV1beta1Config) {
    super(scope, id, config);
  }
}
export interface AlloydbCnrmCloudGoogleComAlloyDBUserV1beta1Config extends ManifestConfig {
  manifest: {
