...
export class AlloydbCnrmCloudGoogleComAlloyDBInstanceV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: AlloydbCnrmCloudGoogleComAlloyDBInstanceV1beta1Config) {
    super(scope, id, config);
  }
}
export interface AlloydbCnrmCloudGoogleComAlloyDBInstanceV1beta1Config extends ManifestConfig {
  manifest: {
