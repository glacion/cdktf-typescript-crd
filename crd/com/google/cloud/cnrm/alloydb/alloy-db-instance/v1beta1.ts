...
export class KubernetesAlloyDBInstanceV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesAlloyDBInstanceV1beta1ManifestConfig) {
