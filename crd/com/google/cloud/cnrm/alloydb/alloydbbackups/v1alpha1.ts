...
export class KubernetesAlloyDBBackupV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesAlloyDBBackupV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "alloydb.cnrm.cloud.google.com/v1alpha1", kind: "AlloyDBBackup", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesAlloyDBBackupV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
