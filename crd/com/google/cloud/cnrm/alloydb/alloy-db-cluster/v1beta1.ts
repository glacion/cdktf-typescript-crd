...
export class AlloydbCnrmCloudGoogleComAlloyDBClusterV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: AlloydbCnrmCloudGoogleComAlloyDBClusterV1beta1Config) {
    super(scope, id, config);
  }
}
export interface AlloydbCnrmCloudGoogleComAlloyDBClusterV1beta1Config extends ManifestConfig {
  manifest: {
