...
export class KubernetesBigtableTableV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesBigtableTableV1beta1ManifestConfig) {
