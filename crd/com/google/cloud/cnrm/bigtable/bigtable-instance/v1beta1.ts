...
export class BigtableCnrmCloudGoogleComBigtableInstanceV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: BigtableCnrmCloudGoogleComBigtableInstanceV1beta1Config) {
    super(scope, id, config);
  }
}
export interface BigtableCnrmCloudGoogleComBigtableInstanceV1beta1Config extends ManifestConfig {
  manifest: {
