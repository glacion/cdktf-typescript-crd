...
export class BigtableCnrmCloudGoogleComBigtableGCPolicyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: BigtableCnrmCloudGoogleComBigtableGCPolicyV1beta1Config) {
    super(scope, id, config);
  }
}
export interface BigtableCnrmCloudGoogleComBigtableGCPolicyV1beta1Config extends ManifestConfig {
  manifest: {
