...
export class KubernetesBigtableInstanceV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesBigtableInstanceV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "bigtable.cnrm.cloud.google.com/v1beta1", kind: "BigtableInstance", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesBigtableInstanceV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
