...
export class ServicedirectoryCnrmCloudGoogleComServiceDirectoryServiceV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: ServicedirectoryCnrmCloudGoogleComServiceDirectoryServiceV1beta1Config,
  ) {
    super(scope, id, config);
  }
}
export interface ServicedirectoryCnrmCloudGoogleComServiceDirectoryServiceV1beta1Config extends ManifestConfig {
  manifest: {
