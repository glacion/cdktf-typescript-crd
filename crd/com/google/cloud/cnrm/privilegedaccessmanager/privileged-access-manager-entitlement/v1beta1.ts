...
export class KubernetesPrivilegedAccessManagerEntitlementV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesPrivilegedAccessManagerEntitlementV1beta1ManifestConfig) {
