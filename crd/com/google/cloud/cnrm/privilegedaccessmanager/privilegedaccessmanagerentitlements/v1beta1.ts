...
export class KubernetesPrivilegedAccessManagerEntitlementV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesPrivilegedAccessManagerEntitlementV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesPrivilegedAccessManagerEntitlementV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
