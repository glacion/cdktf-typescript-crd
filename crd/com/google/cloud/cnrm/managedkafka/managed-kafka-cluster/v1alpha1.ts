...
export class ManagedkafkaCnrmCloudGoogleComManagedKafkaClusterV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, config: ManagedkafkaCnrmCloudGoogleComManagedKafkaClusterV1alpha1Config) {
    super(scope, id, config);
  }
}
export interface ManagedkafkaCnrmCloudGoogleComManagedKafkaClusterV1alpha1Config extends ManifestConfig {
  manifest: {
