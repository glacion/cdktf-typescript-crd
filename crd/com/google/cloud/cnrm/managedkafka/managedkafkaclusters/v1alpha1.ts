...
export class KubernetesManagedKafkaClusterV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesManagedKafkaClusterV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "managedkafka.cnrm.cloud.google.com/v1alpha1", kind: "ManagedKafkaCluster", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesManagedKafkaClusterV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
  ...
  manifest: {
    /** @description ManagedKafkaCluster is the Schema for the ManagedKafkaCluster API */
    spec: {
