...
export class KubernetesBillingBudgetsBudgetV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesBillingBudgetsBudgetV1beta1Config) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesBillingBudgetsBudgetV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
