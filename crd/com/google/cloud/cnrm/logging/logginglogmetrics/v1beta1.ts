...
export class KubernetesLoggingLogMetricV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesLoggingLogMetricV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "logging.cnrm.cloud.google.com/v1beta1", kind: "LoggingLogMetric", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesLoggingLogMetricV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
  ...
  manifest: {
    ...
    spec: {
      ...
      status?: {
        /** @description Conditions represent the latest available observations of the LoggingLogMetric's current state. */
        conditions?: {
