...
export class KubernetesLoggingLogMetricV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesLoggingLogMetricV1beta1ManifestConfig) {
