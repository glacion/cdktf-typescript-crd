...
export class KubernetesLoggingLogViewV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesLoggingLogViewV1beta1ManifestConfig) {
