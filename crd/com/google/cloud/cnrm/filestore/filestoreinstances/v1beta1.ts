...
export class KubernetesFilestoreInstanceV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesFilestoreInstanceV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "filestore.cnrm.cloud.google.com/v1beta1", kind: "FilestoreInstance", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesFilestoreInstanceV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
