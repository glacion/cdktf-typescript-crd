...
export class KubernetesWorkstationV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesWorkstationV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "workstations.cnrm.cloud.google.com/v1alpha1", kind: "Workstation", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesWorkstationV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
