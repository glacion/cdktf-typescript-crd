...
export class WorkstationsCnrmCloudGoogleComWorkstationV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: WorkstationsCnrmCloudGoogleComWorkstationV1beta1Config) {
    super(scope, id, config);
  }
}
export interface WorkstationsCnrmCloudGoogleComWorkstationV1beta1Config extends ManifestConfig {
  manifest: {
