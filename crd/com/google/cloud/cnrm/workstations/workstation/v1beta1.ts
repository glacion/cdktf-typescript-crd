...
export class KubernetesWorkstationV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesWorkstationV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesWorkstationV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
