...
export class KubernetesWorkstationConfigV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesWorkstationConfigV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "workstations.cnrm.cloud.google.com/v1beta1", kind: "WorkstationConfig", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesWorkstationConfigV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
