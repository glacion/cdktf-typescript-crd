...
export class KubernetesWorkstationConfigV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesWorkstationConfigV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "workstations.cnrm.cloud.google.com/v1alpha1", kind: "WorkstationConfig", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesWorkstationConfigV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
  ...
  manifest: {
    /** @description WorkstationConfig is the Schema for the WorkstationConfig API */
    spec: {
