...
export class KubernetesWorkstationClusterV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesWorkstationClusterV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "workstations.cnrm.cloud.google.com/v1alpha1", kind: "WorkstationCluster", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesWorkstationClusterV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
