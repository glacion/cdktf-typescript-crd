...
export class WorkstationsCnrmCloudGoogleComWorkstationClusterV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: WorkstationsCnrmCloudGoogleComWorkstationClusterV1beta1Config) {
    super(scope, id, config);
  }
}
export interface WorkstationsCnrmCloudGoogleComWorkstationClusterV1beta1Config extends ManifestConfig {
  manifest: {
