...
export class KubernetesVertexAIEndpointV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesVertexAIEndpointV1beta1ManifestConfig) {
