...
export class KubernetesVertexAIEndpointV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesVertexAIEndpointV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "vertexai.cnrm.cloud.google.com/v1beta1", kind: "VertexAIEndpoint", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesVertexAIEndpointV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
