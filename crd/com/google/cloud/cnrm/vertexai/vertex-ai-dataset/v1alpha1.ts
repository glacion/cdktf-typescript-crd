...
export class KubernetesVertexAIDatasetV1alpha1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesVertexAIDatasetV1alpha1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesVertexAIDatasetV1alpha1ManifestConfig extends ManifestConfig {
  manifest: {
