...
export class VertexaiCnrmCloudGoogleComVertexAIDatasetV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, config: VertexaiCnrmCloudGoogleComVertexAIDatasetV1alpha1Config) {
    super(scope, id, config);
  }
}
export interface VertexaiCnrmCloudGoogleComVertexAIDatasetV1alpha1Config extends ManifestConfig {
  manifest: {
