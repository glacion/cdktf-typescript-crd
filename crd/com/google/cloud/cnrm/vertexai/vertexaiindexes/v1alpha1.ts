...
export class KubernetesVertexAIIndexV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesVertexAIIndexV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "vertexai.cnrm.cloud.google.com/v1alpha1", kind: "VertexAIIndex", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesVertexAIIndexV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
