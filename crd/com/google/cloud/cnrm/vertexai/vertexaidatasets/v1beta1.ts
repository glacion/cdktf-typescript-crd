...
export class KubernetesVertexAIDatasetV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesVertexAIDatasetV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "vertexai.cnrm.cloud.google.com/v1beta1", kind: "VertexAIDataset", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesVertexAIDatasetV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
