...
export class MemcacheCnrmCloudGoogleComMemcacheInstanceV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: MemcacheCnrmCloudGoogleComMemcacheInstanceV1beta1Config) {
    super(scope, id, config);
  }
}
export interface MemcacheCnrmCloudGoogleComMemcacheInstanceV1beta1Config extends ManifestConfig {
  manifest: {
