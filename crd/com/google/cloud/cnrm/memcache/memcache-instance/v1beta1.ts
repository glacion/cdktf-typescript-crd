...
export class KubernetesMemcacheInstanceV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesMemcacheInstanceV1beta1ManifestConfig) {
