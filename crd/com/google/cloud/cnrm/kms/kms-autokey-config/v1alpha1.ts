...
export class KubernetesKMSAutokeyConfigV1alpha1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesKMSAutokeyConfigV1alpha1ManifestConfig) {
