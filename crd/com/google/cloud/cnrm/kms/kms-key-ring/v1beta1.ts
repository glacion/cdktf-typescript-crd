...
export class KubernetesKMSKeyRingV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesKMSKeyRingV1beta1ManifestConfig) {
