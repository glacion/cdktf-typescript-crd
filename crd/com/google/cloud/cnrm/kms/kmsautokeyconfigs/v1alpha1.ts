...
export class KubernetesKMSAutokeyConfigV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesKMSAutokeyConfigV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "kms.cnrm.cloud.google.com/v1alpha1", kind: "KMSAutokeyConfig", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesKMSAutokeyConfigV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
