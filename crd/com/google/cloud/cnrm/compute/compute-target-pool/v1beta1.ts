...
export class KubernetesComputeTargetPoolV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeTargetPoolV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesComputeTargetPoolV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
