...
export class ComputeCnrmCloudGoogleComComputeHTTPHealthCheckV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeHTTPHealthCheckV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeHTTPHealthCheckV1beta1Config extends ManifestConfig {
  manifest: {
