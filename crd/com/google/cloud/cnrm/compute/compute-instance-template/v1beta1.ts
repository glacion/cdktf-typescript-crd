...
export class ComputeCnrmCloudGoogleComComputeInstanceTemplateV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeInstanceTemplateV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeInstanceTemplateV1beta1Config extends ManifestConfig {
  manifest: {
