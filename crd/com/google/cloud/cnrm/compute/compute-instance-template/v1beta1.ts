...
export class KubernetesComputeInstanceTemplateV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeInstanceTemplateV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesComputeInstanceTemplateV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
