...
export class KubernetesComputeFirewallPolicyRuleV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeFirewallPolicyRuleV1beta1ManifestConfig) {
