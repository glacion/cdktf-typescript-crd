...
export class KubernetesComputeImageV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeImageV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesComputeImageV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
