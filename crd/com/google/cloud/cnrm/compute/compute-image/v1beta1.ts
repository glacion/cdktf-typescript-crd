...
export class ComputeCnrmCloudGoogleComComputeImageV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeImageV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeImageV1beta1Config extends ManifestConfig {
  manifest: {
