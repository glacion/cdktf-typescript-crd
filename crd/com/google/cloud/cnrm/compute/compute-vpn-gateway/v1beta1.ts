...
export class ComputeCnrmCloudGoogleComComputeVPNGatewayV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeVPNGatewayV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeVPNGatewayV1beta1Config extends ManifestConfig {
  manifest: {
