...
export class ComputeCnrmCloudGoogleComComputeNetworkV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeNetworkV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeNetworkV1beta1Config extends ManifestConfig {
  manifest: {
