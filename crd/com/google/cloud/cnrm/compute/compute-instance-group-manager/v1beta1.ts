...
export class ComputeCnrmCloudGoogleComComputeInstanceGroupManagerV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeInstanceGroupManagerV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeInstanceGroupManagerV1beta1Config extends ManifestConfig {
  manifest: {
