...
export class ComputeCnrmCloudGoogleComComputeHTTPSHealthCheckV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeHTTPSHealthCheckV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeHTTPSHealthCheckV1beta1Config extends ManifestConfig {
  manifest: {
