...
export class ComputeCnrmCloudGoogleComComputeURLMapV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeURLMapV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeURLMapV1beta1Config extends ManifestConfig {
  manifest: {
