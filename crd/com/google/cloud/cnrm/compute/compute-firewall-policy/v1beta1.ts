...
export class ComputeCnrmCloudGoogleComComputeFirewallPolicyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeFirewallPolicyV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeFirewallPolicyV1beta1Config extends ManifestConfig {
  manifest: {
