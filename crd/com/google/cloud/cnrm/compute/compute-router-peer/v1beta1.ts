...
export class ComputeCnrmCloudGoogleComComputeRouterPeerV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeRouterPeerV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeRouterPeerV1beta1Config extends ManifestConfig {
  manifest: {
