...
export class KubernetesComputeSecurityPolicyV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeSecurityPolicyV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesComputeSecurityPolicyV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
