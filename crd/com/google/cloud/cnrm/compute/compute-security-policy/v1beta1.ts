...
export class ComputeCnrmCloudGoogleComComputeSecurityPolicyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeSecurityPolicyV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeSecurityPolicyV1beta1Config extends ManifestConfig {
  manifest: {
