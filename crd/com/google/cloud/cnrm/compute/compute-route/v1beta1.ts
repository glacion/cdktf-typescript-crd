...
export class ComputeCnrmCloudGoogleComComputeRouteV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeRouteV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeRouteV1beta1Config extends ManifestConfig {
  manifest: {
