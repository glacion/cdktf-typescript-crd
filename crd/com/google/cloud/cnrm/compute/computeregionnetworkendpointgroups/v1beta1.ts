...
export class KubernetesComputeRegionNetworkEndpointGroupV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesComputeRegionNetworkEndpointGroupV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesComputeRegionNetworkEndpointGroupV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
