...
export class KubernetesComputeDiskV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeDiskV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesComputeDiskV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
