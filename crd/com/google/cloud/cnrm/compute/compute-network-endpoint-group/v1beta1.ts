...
export class KubernetesComputeNetworkEndpointGroupV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeNetworkEndpointGroupV1beta1ManifestConfig) {
