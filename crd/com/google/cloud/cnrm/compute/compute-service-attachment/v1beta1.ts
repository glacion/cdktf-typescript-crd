...
export class ComputeCnrmCloudGoogleComComputeServiceAttachmentV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeServiceAttachmentV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeServiceAttachmentV1beta1Config extends ManifestConfig {
  manifest: {
