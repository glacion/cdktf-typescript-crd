...
export class ComputeCnrmCloudGoogleComComputeInstanceGroupV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeInstanceGroupV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeInstanceGroupV1beta1Config extends ManifestConfig {
  manifest: {
