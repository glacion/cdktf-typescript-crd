...
export class KubernetesComputeHealthCheckV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesComputeHealthCheckV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "compute.cnrm.cloud.google.com/v1beta1", kind: "ComputeHealthCheck", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesComputeHealthCheckV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
