...
export class ComputeCnrmCloudGoogleComComputeSSLPolicyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeSSLPolicyV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeSSLPolicyV1beta1Config extends ManifestConfig {
  manifest: {
