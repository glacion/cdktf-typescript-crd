...
export class KubernetesComputeInterconnectAttachmentV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeInterconnectAttachmentV1beta1ManifestConfig) {
