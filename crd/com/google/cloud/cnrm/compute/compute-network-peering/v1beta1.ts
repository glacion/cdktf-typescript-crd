...
export class KubernetesComputeNetworkPeeringV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeNetworkPeeringV1beta1ManifestConfig) {
