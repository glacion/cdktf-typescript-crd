...
export class ComputeCnrmCloudGoogleComComputeTargetHTTPSProxyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeTargetHTTPSProxyV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeTargetHTTPSProxyV1beta1Config extends ManifestConfig {
  manifest: {
