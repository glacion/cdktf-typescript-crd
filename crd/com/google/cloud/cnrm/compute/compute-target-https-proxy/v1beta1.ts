...
export class KubernetesComputeTargetHTTPSProxyV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeTargetHTTPSProxyV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesComputeTargetHTTPSProxyV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
