...
export class KubernetesComputeFirewallPolicyAssociationV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeFirewallPolicyAssociationV1beta1ManifestConfig) {
