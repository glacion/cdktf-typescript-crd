...
export class KubernetesComputeSSLCertificateV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeSSLCertificateV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesComputeSSLCertificateV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
