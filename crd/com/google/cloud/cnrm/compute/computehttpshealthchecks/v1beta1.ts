...
export class KubernetesComputeHTTPSHealthCheckV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesComputeHTTPSHealthCheckV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "compute.cnrm.cloud.google.com/v1beta1", kind: "ComputeHTTPSHealthCheck", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesComputeHTTPSHealthCheckV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
