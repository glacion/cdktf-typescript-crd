...
export class ComputeCnrmCloudGoogleComComputeRouterV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeRouterV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeRouterV1beta1Config extends ManifestConfig {
  manifest: {
