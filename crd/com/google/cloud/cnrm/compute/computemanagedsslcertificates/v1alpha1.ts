...
export class KubernetesComputeManagedSSLCertificateV1alpha1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesComputeManagedSSLCertificateV1alpha1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesComputeManagedSSLCertificateV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
