...
export class ComputeCnrmCloudGoogleComComputeRouterNATV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeRouterNATV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeRouterNATV1beta1Config extends ManifestConfig {
  manifest: {
