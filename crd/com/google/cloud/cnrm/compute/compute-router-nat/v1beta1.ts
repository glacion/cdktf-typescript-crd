...
export class KubernetesComputeRouterNATV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesComputeRouterNATV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesComputeRouterNATV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
