...
export class ComputeCnrmCloudGoogleComComputeReservationV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ComputeCnrmCloudGoogleComComputeReservationV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ComputeCnrmCloudGoogleComComputeReservationV1beta1Config extends ManifestConfig {
  manifest: {
