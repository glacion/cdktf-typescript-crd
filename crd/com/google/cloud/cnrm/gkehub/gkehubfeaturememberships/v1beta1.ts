...
export class KubernetesGKEHubFeatureMembershipV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesGKEHubFeatureMembershipV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "gkehub.cnrm.cloud.google.com/v1beta1", kind: "GKEHubFeatureMembership", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesGKEHubFeatureMembershipV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
