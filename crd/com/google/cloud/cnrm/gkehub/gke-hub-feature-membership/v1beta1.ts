...
export class GkehubCnrmCloudGoogleComGKEHubFeatureMembershipV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: GkehubCnrmCloudGoogleComGKEHubFeatureMembershipV1beta1Config) {
    super(scope, id, config);
  }
}
export interface GkehubCnrmCloudGoogleComGKEHubFeatureMembershipV1beta1Config extends ManifestConfig {
  manifest: {
