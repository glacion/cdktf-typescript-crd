...
export class KubernetesDataflowJobV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesDataflowJobV1beta1ManifestConfig) {
