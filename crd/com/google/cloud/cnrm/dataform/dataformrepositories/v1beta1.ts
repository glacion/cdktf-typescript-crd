...
export class KubernetesDataformRepositoryV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesDataformRepositoryV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "dataform.cnrm.cloud.google.com/v1beta1", kind: "DataformRepository", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesDataformRepositoryV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
