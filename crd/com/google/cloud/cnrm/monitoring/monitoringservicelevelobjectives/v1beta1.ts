...
export class KubernetesMonitoringServiceLevelObjectiveV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesMonitoringServiceLevelObjectiveV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesMonitoringServiceLevelObjectiveV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
