...
export class KubernetesMonitoringDashboardV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesMonitoringDashboardV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "monitoring.cnrm.cloud.google.com/v1beta1", kind: "MonitoringDashboard", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesMonitoringDashboardV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
