...
export class MonitoringCnrmCloudGoogleComMonitoringUptimeCheckConfigV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: MonitoringCnrmCloudGoogleComMonitoringUptimeCheckConfigV1beta1Config,
  ) {
    super(scope, id, config);
  }
}
export interface MonitoringCnrmCloudGoogleComMonitoringUptimeCheckConfigV1beta1Config extends ManifestConfig {
  manifest: {
