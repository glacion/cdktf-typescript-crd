...
export class MonitoringCnrmCloudGoogleComMonitoringMonitoredProjectV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: MonitoringCnrmCloudGoogleComMonitoringMonitoredProjectV1beta1Config,
  ) {
    super(scope, id, config);
  }
}
export interface MonitoringCnrmCloudGoogleComMonitoringMonitoredProjectV1beta1Config extends ManifestConfig {
  manifest: {
