...
export class KubernetesMonitoringAlertPolicyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesMonitoringAlertPolicyV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "monitoring.cnrm.cloud.google.com/v1beta1", kind: "MonitoringAlertPolicy", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesMonitoringAlertPolicyV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
