...
export class MonitoringCnrmCloudGoogleComMonitoringGroupV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: MonitoringCnrmCloudGoogleComMonitoringGroupV1beta1Config) {
    super(scope, id, config);
  }
}
export interface MonitoringCnrmCloudGoogleComMonitoringGroupV1beta1Config extends ManifestConfig {
  manifest: {
