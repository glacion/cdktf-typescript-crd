...
export class KubernetesMonitoringUptimeCheckConfigV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesMonitoringUptimeCheckConfigV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesMonitoringUptimeCheckConfigV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
