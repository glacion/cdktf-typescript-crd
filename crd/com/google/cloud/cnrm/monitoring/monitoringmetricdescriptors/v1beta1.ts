...
export class KubernetesMonitoringMetricDescriptorV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesMonitoringMetricDescriptorV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesMonitoringMetricDescriptorV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
