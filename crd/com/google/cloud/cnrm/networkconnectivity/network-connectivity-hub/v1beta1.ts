...
export class NetworkconnectivityCnrmCloudGoogleComNetworkConnectivityHubV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: NetworkconnectivityCnrmCloudGoogleComNetworkConnectivityHubV1beta1Config,
  ) {
    super(scope, id, config);
  }
}
export interface NetworkconnectivityCnrmCloudGoogleComNetworkConnectivityHubV1beta1Config extends ManifestConfig {
  manifest: {
