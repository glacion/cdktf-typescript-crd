...
export class KubernetesRecaptchaEnterpriseKeyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesRecaptchaEnterpriseKeyV1beta1Config) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesRecaptchaEnterpriseKeyV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
