...
export class KubernetesCertificateManagerCertificateMapV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesCertificateManagerCertificateMapV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesCertificateManagerCertificateMapV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
