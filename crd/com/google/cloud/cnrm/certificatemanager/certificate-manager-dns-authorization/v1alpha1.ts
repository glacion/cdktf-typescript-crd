...
export class KubernetesCertificateManagerDNSAuthorizationV1alpha1Manifest extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: KubernetesCertificateManagerDNSAuthorizationV1alpha1ManifestConfig,
  ) {
