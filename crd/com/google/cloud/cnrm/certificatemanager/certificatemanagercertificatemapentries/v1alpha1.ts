...
export class KubernetesCertificateManagerCertificateMapEntryV1alpha1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesCertificateManagerCertificateMapEntryV1alpha1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesCertificateManagerCertificateMapEntryV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
