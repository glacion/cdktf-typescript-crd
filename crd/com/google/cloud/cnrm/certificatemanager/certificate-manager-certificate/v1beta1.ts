...
export class CertificatemanagerCnrmCloudGoogleComCertificateManagerCertificateV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: CertificatemanagerCnrmCloudGoogleComCertificateManagerCertificateV1beta1Config,
  ) {
    super(scope, id, config);
  }
}
export interface CertificatemanagerCnrmCloudGoogleComCertificateManagerCertificateV1beta1Config extends ManifestConfig {
  manifest: {
