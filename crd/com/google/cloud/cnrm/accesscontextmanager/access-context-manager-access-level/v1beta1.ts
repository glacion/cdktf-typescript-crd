...
export class KubernetesAccessContextManagerAccessLevelV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesAccessContextManagerAccessLevelV1beta1ManifestConfig) {
