...
export class KubernetesSQLInstanceV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesSQLInstanceV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "sql.cnrm.cloud.google.com/v1beta1", kind: "SQLInstance", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesSQLInstanceV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
