...
export class KubernetesServiceNetworkingConnectionV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesServiceNetworkingConnectionV1beta1ManifestConfig) {
