...
export class KubernetesBigQueryConnectionConnectionV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesBigQueryConnectionConnectionV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesBigQueryConnectionConnectionV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
