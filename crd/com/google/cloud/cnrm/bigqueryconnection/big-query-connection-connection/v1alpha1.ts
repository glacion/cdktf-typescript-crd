...
export class KubernetesBigQueryConnectionConnectionV1alpha1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesBigQueryConnectionConnectionV1alpha1ManifestConfig) {
