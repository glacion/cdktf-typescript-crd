...
export class DatacatalogCnrmCloudGoogleComDataCatalogTaxonomyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: DatacatalogCnrmCloudGoogleComDataCatalogTaxonomyV1beta1Config) {
    super(scope, id, config);
  }
}
export interface DatacatalogCnrmCloudGoogleComDataCatalogTaxonomyV1beta1Config extends ManifestConfig {
  manifest: {
