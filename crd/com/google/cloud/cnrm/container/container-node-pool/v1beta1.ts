...
export class ContainerCnrmCloudGoogleComContainerNodePoolV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ContainerCnrmCloudGoogleComContainerNodePoolV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ContainerCnrmCloudGoogleComContainerNodePoolV1beta1Config extends ManifestConfig {
  manifest: {
