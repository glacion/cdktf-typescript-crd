...
export class KubernetesContainerNodePoolV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesContainerNodePoolV1beta1ManifestConfig) {
