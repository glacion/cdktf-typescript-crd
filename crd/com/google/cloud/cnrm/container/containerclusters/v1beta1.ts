...
export class KubernetesContainerClusterV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesContainerClusterV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "container.cnrm.cloud.google.com/v1beta1", kind: "ContainerCluster", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesContainerClusterV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
