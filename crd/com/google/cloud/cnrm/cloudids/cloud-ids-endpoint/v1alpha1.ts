...
export class KubernetesCloudIDSEndpointV1alpha1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesCloudIDSEndpointV1alpha1ManifestConfig) {
