...
export class KubernetesStorageBucketV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesStorageBucketV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "storage.cnrm.cloud.google.com/v1beta1", kind: "StorageBucket", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesStorageBucketV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
