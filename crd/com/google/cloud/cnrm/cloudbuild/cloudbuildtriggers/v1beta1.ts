...
export class KubernetesCloudBuildTriggerV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesCloudBuildTriggerV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "cloudbuild.cnrm.cloud.google.com/v1beta1", kind: "CloudBuildTrigger", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesCloudBuildTriggerV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
