...
export class KubernetesBigQueryTableV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesBigQueryTableV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "bigquery.cnrm.cloud.google.com/v1beta1", kind: "BigQueryTable", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesBigQueryTableV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
