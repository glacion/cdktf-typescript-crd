...
export class KubernetesBigQueryJobV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesBigQueryJobV1beta1ManifestConfig) {
