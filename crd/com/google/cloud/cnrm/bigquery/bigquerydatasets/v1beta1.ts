...
export class KubernetesBigQueryDatasetV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesBigQueryDatasetV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "bigquery.cnrm.cloud.google.com/v1beta1", kind: "BigQueryDataset", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesBigQueryDatasetV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
