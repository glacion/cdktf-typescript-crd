...
export class DnsCnrmCloudGoogleComDNSManagedZoneV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: DnsCnrmCloudGoogleComDNSManagedZoneV1beta1Config) {
    super(scope, id, config);
  }
}
export interface DnsCnrmCloudGoogleComDNSManagedZoneV1beta1Config extends ManifestConfig {
  manifest: {
