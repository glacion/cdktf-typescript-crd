...
export class KubernetesDNSManagedZoneV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesDNSManagedZoneV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "dns.cnrm.cloud.google.com/v1beta1", kind: "DNSManagedZone", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesDNSManagedZoneV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
