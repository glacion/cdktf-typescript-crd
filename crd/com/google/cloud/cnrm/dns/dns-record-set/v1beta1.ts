...
export class KubernetesDNSRecordSetV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesDNSRecordSetV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesDNSRecordSetV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
