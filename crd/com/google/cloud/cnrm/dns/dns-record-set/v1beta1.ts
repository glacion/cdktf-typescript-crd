...
export class DnsCnrmCloudGoogleComDNSRecordSetV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: DnsCnrmCloudGoogleComDNSRecordSetV1beta1Config) {
    super(scope, id, config);
  }
}
export interface DnsCnrmCloudGoogleComDNSRecordSetV1beta1Config extends ManifestConfig {
  manifest: {
