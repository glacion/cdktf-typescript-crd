...
export class KubernetesOSConfigOSPolicyAssignmentV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesOSConfigOSPolicyAssignmentV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesOSConfigOSPolicyAssignmentV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
