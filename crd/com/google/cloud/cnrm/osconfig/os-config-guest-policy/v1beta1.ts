...
export class KubernetesOSConfigGuestPolicyV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesOSConfigGuestPolicyV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesOSConfigGuestPolicyV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
