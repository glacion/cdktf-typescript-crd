...
export class OsconfigCnrmCloudGoogleComOSConfigGuestPolicyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: OsconfigCnrmCloudGoogleComOSConfigGuestPolicyV1beta1Config) {
    super(scope, id, config);
  }
}
export interface OsconfigCnrmCloudGoogleComOSConfigGuestPolicyV1beta1Config extends ManifestConfig {
  manifest: {
