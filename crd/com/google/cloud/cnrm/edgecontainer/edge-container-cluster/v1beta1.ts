...
export class KubernetesEdgeContainerClusterV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesEdgeContainerClusterV1beta1ManifestConfig) {
