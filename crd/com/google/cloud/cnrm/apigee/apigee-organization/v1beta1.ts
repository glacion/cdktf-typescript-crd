...
export class ApigeeCnrmCloudGoogleComApigeeOrganizationV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: ApigeeCnrmCloudGoogleComApigeeOrganizationV1beta1Config) {
    super(scope, id, config);
  }
}
export interface ApigeeCnrmCloudGoogleComApigeeOrganizationV1beta1Config extends ManifestConfig {
  manifest: {
