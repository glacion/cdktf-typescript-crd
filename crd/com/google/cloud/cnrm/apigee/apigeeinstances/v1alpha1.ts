...
export class KubernetesApigeeInstanceV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesApigeeInstanceV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "apigee.cnrm.cloud.google.com/v1alpha1", kind: "ApigeeInstance", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesApigeeInstanceV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
