...
export class EventarcCnrmCloudGoogleComEventarcTriggerV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: EventarcCnrmCloudGoogleComEventarcTriggerV1beta1Config) {
    super(scope, id, config);
  }
}
export interface EventarcCnrmCloudGoogleComEventarcTriggerV1beta1Config extends ManifestConfig {
  manifest: {
