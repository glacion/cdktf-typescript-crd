...
export class KubernetesEventarcTriggerV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesEventarcTriggerV1beta1ManifestConfig) {
