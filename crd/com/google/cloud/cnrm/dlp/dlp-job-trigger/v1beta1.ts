...
export class KubernetesDLPJobTriggerV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesDLPJobTriggerV1beta1ManifestConfig) {
