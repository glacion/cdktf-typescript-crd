...
export class DlpCnrmCloudGoogleComDLPJobTriggerV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: DlpCnrmCloudGoogleComDLPJobTriggerV1beta1Config) {
    super(scope, id, config);
  }
}
export interface DlpCnrmCloudGoogleComDLPJobTriggerV1beta1Config extends ManifestConfig {
  manifest: {
