...
export class KubernetesIdentityPlatformTenantOAuthIDPConfigV1beta1Manifest extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: KubernetesIdentityPlatformTenantOAuthIDPConfigV1beta1ManifestConfig,
  ) {
