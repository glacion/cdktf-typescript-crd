...
export class KubernetesIdentityPlatformTenantOAuthIDPConfigV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesIdentityPlatformTenantOAuthIDPConfigV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesIdentityPlatformTenantOAuthIDPConfigV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
