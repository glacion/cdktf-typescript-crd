...
export class EdgenetworkCnrmCloudGoogleComEdgeNetworkSubnetV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: EdgenetworkCnrmCloudGoogleComEdgeNetworkSubnetV1beta1Config) {
    super(scope, id, config);
  }
}
export interface EdgenetworkCnrmCloudGoogleComEdgeNetworkSubnetV1beta1Config extends ManifestConfig {
  manifest: {
