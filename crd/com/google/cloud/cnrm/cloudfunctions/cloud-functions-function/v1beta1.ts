...
export class CloudfunctionsCnrmCloudGoogleComCloudFunctionsFunctionV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: CloudfunctionsCnrmCloudGoogleComCloudFunctionsFunctionV1beta1Config,
  ) {
    super(scope, id, config);
  }
}
export interface CloudfunctionsCnrmCloudGoogleComCloudFunctionsFunctionV1beta1Config extends ManifestConfig {
  manifest: {
