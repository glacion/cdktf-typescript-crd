...
export class KubernetesCloudFunctionsFunctionV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesCloudFunctionsFunctionV1beta1Config) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesCloudFunctionsFunctionV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
