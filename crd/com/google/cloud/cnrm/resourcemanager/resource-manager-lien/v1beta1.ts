...
export class KubernetesResourceManagerLienV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesResourceManagerLienV1beta1ManifestConfig) {
