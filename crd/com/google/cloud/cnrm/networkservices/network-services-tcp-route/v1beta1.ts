...
export class NetworkservicesCnrmCloudGoogleComNetworkServicesTCPRouteV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: NetworkservicesCnrmCloudGoogleComNetworkServicesTCPRouteV1beta1Config,
  ) {
    super(scope, id, config);
  }
}
export interface NetworkservicesCnrmCloudGoogleComNetworkServicesTCPRouteV1beta1Config extends ManifestConfig {
  manifest: {
