...
export class KubernetesNetworkServicesHTTPRouteV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesNetworkServicesHTTPRouteV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesNetworkServicesHTTPRouteV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
