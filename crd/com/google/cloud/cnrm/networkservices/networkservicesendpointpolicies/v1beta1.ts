...
export class KubernetesNetworkServicesEndpointPolicyV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesNetworkServicesEndpointPolicyV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesNetworkServicesEndpointPolicyV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
