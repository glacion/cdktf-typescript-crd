...
export class KubernetesNetworkServicesGRPCRouteV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesNetworkServicesGRPCRouteV1beta1Config) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesNetworkServicesGRPCRouteV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
