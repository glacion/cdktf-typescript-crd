...
export class KubernetesNetworkServicesHTTPRouteV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesNetworkServicesHTTPRouteV1beta1Config) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesNetworkServicesHTTPRouteV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
