...
export class NetworkservicesCnrmCloudGoogleComNetworkServicesTLSRouteV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: NetworkservicesCnrmCloudGoogleComNetworkServicesTLSRouteV1beta1Config,
  ) {
    super(scope, id, config);
  }
}
export interface NetworkservicesCnrmCloudGoogleComNetworkServicesTLSRouteV1beta1Config extends ManifestConfig {
  manifest: {
