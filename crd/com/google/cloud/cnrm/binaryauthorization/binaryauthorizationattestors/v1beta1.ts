...
export class KubernetesBinaryAuthorizationAttestorV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesBinaryAuthorizationAttestorV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesBinaryAuthorizationAttestorV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
