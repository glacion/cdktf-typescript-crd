...
export class SpannerCnrmCloudGoogleComSpannerInstanceV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: SpannerCnrmCloudGoogleComSpannerInstanceV1beta1Config) {
    super(scope, id, config);
  }
}
export interface SpannerCnrmCloudGoogleComSpannerInstanceV1beta1Config extends ManifestConfig {
  manifest: {
