...
export class KubernetesPrivateCACertificateTemplateV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesPrivateCACertificateTemplateV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesPrivateCACertificateTemplateV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
