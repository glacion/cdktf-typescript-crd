...
export class VpcaccessCnrmCloudGoogleComVPCAccessConnectorV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: VpcaccessCnrmCloudGoogleComVPCAccessConnectorV1beta1Config) {
    super(scope, id, config);
  }
}
export interface VpcaccessCnrmCloudGoogleComVPCAccessConnectorV1beta1Config extends ManifestConfig {
  manifest: {
