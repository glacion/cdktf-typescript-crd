...
export class KubernetesVPCAccessConnectorV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesVPCAccessConnectorV1beta1ManifestConfig) {
