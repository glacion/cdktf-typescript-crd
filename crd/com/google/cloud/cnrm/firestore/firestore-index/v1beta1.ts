...
export class KubernetesFirestoreIndexV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesFirestoreIndexV1beta1ManifestConfig) {
