...
export class KubernetesBigQueryDataTransferConfigV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesBigQueryDataTransferConfigV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesBigQueryDataTransferConfigV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
        ...
        scheduleOptionsV2?: {
          ...
          eventDrivenSchedule?: {
            ...
            pubSubSubscriptionRef?: {
              /** @description If provided must be in the format `projects/[project_id]/subscriptions/[subscription_id]`. */
              external?: string;
              /** @description The `metadata.name` field of a `PubSubSubscription` resource. */
              name?: string;
              /** @description The `metadata.namespace` field of a `PubSubSubscription` resource. */
              namespace?: string;
            } & (unknown | unknown);
          };
