...
export class KubernetesNamespacedControllerResourceV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesNamespacedControllerResourceV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesNamespacedControllerResourceV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
