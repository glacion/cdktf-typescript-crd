...
export class CustomizeCoreCnrmCloudGoogleComMutatingWebhookConfigurationCustomizationV1alpha1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: CustomizeCoreCnrmCloudGoogleComMutatingWebhookConfigurationCustomizationV1alpha1Config,
  ) {
    super(scope, id, config);
  }
}
export interface CustomizeCoreCnrmCloudGoogleComMutatingWebhookConfigurationCustomizationV1alpha1Config
