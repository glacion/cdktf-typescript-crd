...
export class KubernetesMutatingWebhookConfigurationCustomizationV1alpha1Manifest extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: KubernetesMutatingWebhookConfigurationCustomizationV1alpha1ManifestConfig,
  ) {
    super(scope, id, config);
  }
}
export interface KubernetesMutatingWebhookConfigurationCustomizationV1alpha1ManifestConfig extends ManifestConfig {
  manifest: {
