...
export class KubernetesNamespacedControllerReconcilerV1alpha1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesNamespacedControllerReconcilerV1alpha1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesNamespacedControllerReconcilerV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
