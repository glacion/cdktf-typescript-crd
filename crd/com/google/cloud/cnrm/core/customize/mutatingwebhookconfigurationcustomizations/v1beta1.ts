...
export class KubernetesMutatingWebhookConfigurationCustomizationV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesMutatingWebhookConfigurationCustomizationV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesMutatingWebhookConfigurationCustomizationV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
  ...
  manifest: {
    /** @description MutatingWebhookConfigurationCustomization is the Schema for customizing the mutating webhook
