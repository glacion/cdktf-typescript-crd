...
export class KubernetesControllerReconcilerV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesControllerReconcilerV1beta1Config) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesControllerReconcilerV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
