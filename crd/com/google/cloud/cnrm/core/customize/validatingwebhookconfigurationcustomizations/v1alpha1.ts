...
export class KubernetesValidatingWebhookConfigurationCustomizationV1alpha1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesValidatingWebhookConfigurationCustomizationV1alpha1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesValidatingWebhookConfigurationCustomizationV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
