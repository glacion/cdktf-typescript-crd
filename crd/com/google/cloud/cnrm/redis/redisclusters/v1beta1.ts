...
export class KubernetesRedisClusterV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesRedisClusterV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "redis.cnrm.cloud.google.com/v1beta1", kind: "RedisCluster", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesRedisClusterV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
