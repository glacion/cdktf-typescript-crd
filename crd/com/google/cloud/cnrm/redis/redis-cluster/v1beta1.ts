...
export class RedisCnrmCloudGoogleComRedisClusterV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: RedisCnrmCloudGoogleComRedisClusterV1beta1Config) {
    super(scope, id, config);
  }
}
export interface RedisCnrmCloudGoogleComRedisClusterV1beta1Config extends ManifestConfig {
  manifest: {
