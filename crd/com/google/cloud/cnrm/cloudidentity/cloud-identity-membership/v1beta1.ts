...
export class CloudidentityCnrmCloudGoogleComCloudIdentityMembershipV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    config: CloudidentityCnrmCloudGoogleComCloudIdentityMembershipV1beta1Config,
  ) {
    super(scope, id, config);
  }
}
export interface CloudidentityCnrmCloudGoogleComCloudIdentityMembershipV1beta1Config extends ManifestConfig {
  manifest: {
