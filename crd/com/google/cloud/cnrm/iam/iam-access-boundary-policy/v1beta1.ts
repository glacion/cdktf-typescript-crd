...
export class IamCnrmCloudGoogleComIAMAccessBoundaryPolicyV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: IamCnrmCloudGoogleComIAMAccessBoundaryPolicyV1beta1Config) {
    super(scope, id, config);
  }
}
export interface IamCnrmCloudGoogleComIAMAccessBoundaryPolicyV1beta1Config extends ManifestConfig {
  manifest: {
