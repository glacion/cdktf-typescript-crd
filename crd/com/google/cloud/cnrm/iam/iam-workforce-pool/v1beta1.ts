...
export class KubernetesIAMWorkforcePoolV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesIAMWorkforcePoolV1beta1ManifestConfig) {
