...
export class IamCnrmCloudGoogleComIAMWorkforcePoolV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: IamCnrmCloudGoogleComIAMWorkforcePoolV1beta1Config) {
    super(scope, id, config);
  }
}
export interface IamCnrmCloudGoogleComIAMWorkforcePoolV1beta1Config extends ManifestConfig {
  manifest: {
