...
export class IamCnrmCloudGoogleComIAMServiceAccountV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: IamCnrmCloudGoogleComIAMServiceAccountV1beta1Config) {
    super(scope, id, config);
  }
}
export interface IamCnrmCloudGoogleComIAMServiceAccountV1beta1Config extends ManifestConfig {
  manifest: {
