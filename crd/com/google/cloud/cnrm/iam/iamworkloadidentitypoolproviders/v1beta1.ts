...
export class KubernetesIAMWorkloadIdentityPoolProviderV1beta1 extends Manifest {
  constructor(
    scope: Construct,
    id: string,
    { manifest, ...config }: KubernetesIAMWorkloadIdentityPoolProviderV1beta1Config,
  ) {
    super(scope, id, {
      manifest: {
...
export interface KubernetesIAMWorkloadIdentityPoolProviderV1beta1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
