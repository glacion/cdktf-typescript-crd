...
export class IamCnrmCloudGoogleComIAMCustomRoleV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: IamCnrmCloudGoogleComIAMCustomRoleV1beta1Config) {
    super(scope, id, config);
  }
}
export interface IamCnrmCloudGoogleComIAMCustomRoleV1beta1Config extends ManifestConfig {
  manifest: {
