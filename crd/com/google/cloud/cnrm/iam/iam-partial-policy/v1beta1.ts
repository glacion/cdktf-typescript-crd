...
export class KubernetesIAMPartialPolicyV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesIAMPartialPolicyV1beta1ManifestConfig) {
    super(scope, id, config);
  }
}
export interface KubernetesIAMPartialPolicyV1beta1ManifestConfig extends ManifestConfig {
  manifest: {
