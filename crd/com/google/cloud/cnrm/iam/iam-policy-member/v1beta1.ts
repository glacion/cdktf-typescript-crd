...
export class KubernetesIAMPolicyMemberV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesIAMPolicyMemberV1beta1ManifestConfig) {
