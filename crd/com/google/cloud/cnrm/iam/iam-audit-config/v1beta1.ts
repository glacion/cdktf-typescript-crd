...
export class IamCnrmCloudGoogleComIAMAuditConfigV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: IamCnrmCloudGoogleComIAMAuditConfigV1beta1Config) {
    super(scope, id, config);
  }
}
export interface IamCnrmCloudGoogleComIAMAuditConfigV1beta1Config extends ManifestConfig {
  manifest: {
