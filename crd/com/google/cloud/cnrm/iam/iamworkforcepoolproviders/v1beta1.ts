...
export class KubernetesIAMWorkforcePoolProviderV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesIAMWorkforcePoolProviderV1beta1Config) {
    super(scope, id, {
      manifest: { apiVersion: "iam.cnrm.cloud.google.com/v1beta1", kind: "IAMWorkforcePoolProvider", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesIAMWorkforcePoolProviderV1beta1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
