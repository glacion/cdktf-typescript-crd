...
export class KubernetesBackendConfigV1beta1Manifest extends Manifest {
  constructor(scope: Construct, id: string, config: KubernetesBackendConfigV1beta1ManifestConfig) {
