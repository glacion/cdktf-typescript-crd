...
export class CloudGoogleComBackendConfigV1beta1 extends Manifest {
  constructor(scope: Construct, id: string, config: CloudGoogleComBackendConfigV1beta1Config) {
    super(scope, id, config);
  }
}
export interface CloudGoogleComBackendConfigV1beta1Config extends ManifestConfig {
  manifest: {
