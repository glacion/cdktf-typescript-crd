...
export class KubernetesPodMonitoringV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesPodMonitoringV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "monitoring.googleapis.com/v1alpha1", kind: "PodMonitoring", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesPodMonitoringV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
