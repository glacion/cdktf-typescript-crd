...
export class MonitoringGoogleapisComClusterRulesV1 extends Manifest {
  constructor(scope: Construct, id: string, config: MonitoringGoogleapisComClusterRulesV1Config) {
    super(scope, id, config);
  }
}
export interface MonitoringGoogleapisComClusterRulesV1Config extends ManifestConfig {
  manifest: {
