...
export class KubernetesClusterNodeMonitoringV1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesClusterNodeMonitoringV1Config) {
    super(scope, id, {
      manifest: { apiVersion: "monitoring.googleapis.com/v1", kind: "ClusterNodeMonitoring", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesClusterNodeMonitoringV1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
