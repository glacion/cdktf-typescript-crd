...
export class KubernetesAutoscalingRunnerSetV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesAutoscalingRunnerSetV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "actions.github.com/v1alpha1", kind: "AutoscalingRunnerSet", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesAutoscalingRunnerSetV1alpha1Config extends ManifestConfig {
  manifest: {
    metadata: {
      annotations?: {
        [key: string]: string;
