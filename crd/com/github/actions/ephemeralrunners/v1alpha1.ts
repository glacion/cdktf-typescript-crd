...
export class KubernetesEphemeralRunnerV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesEphemeralRunnerV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "actions.github.com/v1alpha1", kind: "EphemeralRunner", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesEphemeralRunnerV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
