...
export class KubernetesEphemeralRunnerSetV1alpha1 extends Manifest {
  constructor(scope: Construct, id: string, { manifest, ...config }: KubernetesEphemeralRunnerSetV1alpha1Config) {
    super(scope, id, {
      manifest: { apiVersion: "actions.github.com/v1alpha1", kind: "EphemeralRunnerSet", ...manifest },
      ...config,
    });
  }
}
export interface KubernetesEphemeralRunnerSetV1alpha1Config extends ManifestConfig {
  metadata: {
    annotations?: {
      [key: string]: string;
    };
